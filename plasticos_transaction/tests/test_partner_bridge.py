...
class TestUnknownModel(TransactionCase):
    ...
    def test_action_view_plasticos_transactions_executes_successfully(self):
        """Test action_view_plasticos_transactions executes without error"""
        record = self._create_model()

        result = record.action_view_plasticos_transactions()
