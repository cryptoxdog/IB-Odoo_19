...
class TestUnknownModel(TransactionCase):
    ...
    def test_action_view_facility_profiles_executes_successfully(self):
        """Test action_view_facility_profiles executes without error"""
        record = self._create_model()

        result = record.action_view_facility_profiles()
