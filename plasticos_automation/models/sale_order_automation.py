...
class SaleOrderAutomation(models.Model):
    ...
    def action_request_dock_appointment(self):
        ...
        for rec in self:
            rec.appointment_requested = True
            rec.appointment_requested_on = fields.Datetime.now()
            rec.message_post(
