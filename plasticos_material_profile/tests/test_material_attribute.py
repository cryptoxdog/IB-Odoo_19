...
class TestPlasticosMaterialAttribute(TransactionCase):
    ...
    def _create_attribute(self, **kwargs):
        """Helper to create plasticos.material.attribute with defaults"""
        vals = {
            # TODO: Add required fields
        }
        vals.update(kwargs)
        return self.env["plasticos.material.attribute"].create(vals)
