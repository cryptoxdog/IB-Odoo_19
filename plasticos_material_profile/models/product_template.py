...
class ProductTemplate(models.Model):
    ...
    # Related fields must match the source field type
    material_polymer = fields.Selection(
        related="material_profile_id.polymer",
        string="Profile Polymer",  # Distinct from polymer_id label
        readonly=True,
        store=True,
    )

    material_form = fields.Selection(
        related="material_profile_id.form",
        string="Form",
        readonly=True,
        store=True,
    )
