...
3. Existing `skills/plasticos-*-kernel` skills when their scope matches — don't duplicate work; run the more specific kernel and borrow the prompt-pack doc's extra structure (phases, blocks) as the report/response format.
