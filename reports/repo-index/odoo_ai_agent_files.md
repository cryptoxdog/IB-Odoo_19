# AI Agent Files Index

| file | name | kind |
|------|------|------|
| `AI Agent Files/AGENT.md` | AGENT.md | doc |
| `AI Agent Files/ARCHITECTURE.md` | ARCHITECTURE.md | doc |
...
| `AI Agent Files/GLOSSARY.md` | GLOSSARY.md | doc |
...
| `AI Agent Files/README_harvested.md` | README_harvested.md | doc |
| `AI Agent Files/ROADMAP.md` | ROADMAP.md | doc |
| `AI Agent Files/SECURITY_MODEL.md` | SECURITY_MODEL.md | doc |
| `AI Agent Files/TEST_STRATEGY.md` | TEST_STRATEGY.md | doc |
| `AI Agent Files/compliance_scan.json` | compliance_scan.json | data |
...
| `AI Agent Files/repo_spec.md` | repo_spec.md | doc |
