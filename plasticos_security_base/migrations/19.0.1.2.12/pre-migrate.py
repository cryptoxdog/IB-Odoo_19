...
19.0.1.2.12 re-runs after #148 so Staging applies orphan ir.rule cleanup even
when 19.0.1.2.11 already completed with the pre-fix migrate scripts.
"""
...
def migrate(cr, version):
    _rehome_load_dashboard_xmlids(cr, "plasticos_security_base 19.0.1.2.12 pre")
